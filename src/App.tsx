  ...
  return <div className="app-shell">
    ...
    <main className="main-content">
      ...
      <div className="page-wrap">
        <section className="page-heading"><div><p className="eyebrow"><span /> Monday, September 1, 2026</p><h1>Good morning, Jose<span>.</span></h1><p className="subheading">Here’s the pulse of your growth engine.</p></div><div className="heading-actions"><button className="button button-quiet"><Filter size={15} /> Filter</button><button className="button button-primary"><Plus size={16} /> Add lead</button></div></section>
