...
const moduleDescriptions: Record<string, string> = {
  'Leads & pipeline': 'Capture inquiries, qualify opportunities and move them through a repeatable sales process.',
  Companies: 'Keep company records, contacts, relationship history and account ownership together.',
  Campaigns: 'Connect campaigns to products, channels and first/last-touch attribution.',
  Analytics: 'Compare product performance once live event sources are connected.',
  Conversations: 'Review AI and human conversations with consent, summaries and follow-up actions.',
  'Account registry': 'Track the health and ownership of every analytics, advertising and product connection.',
};
  ...
  return <div className="app-shell">
    ...
    <main className="main-content">
      ...
      <div className="page-wrap">
        ...
        {active !== 'Overview' && <section className="module-placeholder"><div className="module-placeholder-icon"><Sparkles size={18} /></div><div><p className="eyebrow"><span /> Module preview</p><h2>{active}</h2><p>{moduleDescriptions[active] || 'This workspace module is ready for its next implementation milestone.'}</p></div><button className="button button-primary" onClick={() => setActive('Overview')}>Back to overview <ArrowUpRight size={14} /></button></section>}
